    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Add Club
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <form method="post" enctype="multipart/form-data" action="{{url('admin/club')}}">
                        @csrf
                        <table class="table table-bordered" >
                            <tr>
                                <th>Club Name <span class="text-danger">*</span></th>
                                <td><input name="club_name" type="text" class="form-control" /></td>
                            </tr>
                            <tr>
