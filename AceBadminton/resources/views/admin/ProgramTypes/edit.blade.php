...
{{--                                    </table>--}}
                            ...
                            <tr>
                                <th>Select Facility 1</th>
                                <td>
                                    <select name="facility_1" class="form-control">
                                        <option value="{{null}}" @if($data->facility_1 == null) selected @endif>--- Select ---</option>
                                        <option value="Indoor" @if($data->facility_1 == 'Indoor') selected @endif>Indoor</option>
                                        <option value="Outdoor" @if($data->facility_1 == 'Outdoor') selected @endif>Outdoor</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <th>Select Facility 2</th>
                                <td>
                                    <select name="facility_2" class="form-control">
                                        <option value="{{null}}" @if($data->facility_2 == null) selected @endif>--- Select ---</option>
                                        <option value="Rubber Flooring" @if($data->facility_2 == 'Rubber Flooring') selected @endif>Rubber Flooring</option>
                                        <option value="Wooden Flooring" @if($data->facility_2 == 'Wooden Flooring') selected @endif>Wooden Flooring</option>
                                        <option value="Hard Flooring" @if($data->facility_2 == 'Hard Flooring') selected @endif>Hard Flooring</option>
                                    </select>
                                </td>
                            </tr>
