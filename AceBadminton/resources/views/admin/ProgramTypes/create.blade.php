...
{{--                            </tr>--}}
                        ...
                        <tr>
                            ...
                            <tr>
                                <th>Facility 1</th>
                                <td>
                                    <select name="facility_1" class="form-control" method="post">
                                        <option value="0">--- Select Facility 1 ---</option>
                            ...
                            <tr>
                                <th>Facility 2</th>
                                <td>
                                    <select name="facility_2" class="form-control" method="post">
                                        <option value="0">--- Select Facility 2 ---</option>
